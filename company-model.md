...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "SECPRAL") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/secpral-pro-instalatii-srl-nodejs-scraper/main/.github/workflows/run-spishop.yml`)
